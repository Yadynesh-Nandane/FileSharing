...
def mainWindow():
    ...
    sentimentBtn = tk.Button(videosSubFrame, text="Sentiment Analysis", width=20, height=1, bg="#D99594", command=moviesFrame)
    sentimentBtn.config(font=("", 15))
    sentimentBtn.grid(row=2, column=0, columnspan=1)

    summaryBtn = tk.Button(videosSubFrame, text="Generate Summary", width=20, height=1, bg="#D99594", command=moviesFrame)
    ...
    summary = tk.Text(videosSubFrame, width=88, height=20, bg="#EEECE1")
    ...
    summaryBtn = tk.Button(videosSubFrame, text="Save as PDF", width=20, height=1, bg="#D99594", command=moviesFrame)
    summaryBtn.config(font=("", 15))
    ...
    msentimentBtn = tk.Button(moviesSubFrame, text="Sentiment Analysis", width=20, height=1, bg="#D99594", command=moviesFrame)
    msentimentBtn.config(font=("", 15))
    msentimentBtn.grid(row=2, column=0, columnspan=1)

    msummaryBtn = tk.Button(moviesSubFrame, text="Generate Summary", width=20, height=1, bg="#D99594", command=moviesFrame)
    ...
    msummary = tk.Text(moviesSubFrame, width=88, height=20, bg="#EEECE1")
    ...
    msummarysaveBtn = tk.Button(moviesSubFrame, text="Save as PDF", width=20, height=1, bg="#D99594", command=moviesFrame)
